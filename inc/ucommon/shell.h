...
public:
     ...
     */
    typedef enum {USER_CONFIG, SYSTEM_CONFIG, USER_DEFAULTS, PUBLIC_CERTS, PRIVATE_CERTS, USER_HOME, SYSTEM_DATA, SYSTEM_TEMP, USER_CACHE, SYSTEM_CACHE, LOCAL_DATA, LOCAL_CONFIG, SYSTEM_CFG, SYSTEM_ETC, SYSTEM_VAR, SYSTEM_PREFIX} path_t;

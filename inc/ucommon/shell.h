...
public:
     ...
     */
    typedef enum {PROGRAM_CONFIG, SYSTEM_CONFIG, USER_DEFAULTS, PUBLIC_CERTS,
        PRIVATE_CERTS, USER_HOME, PROGRAM_DATA, SYSTEM_TEMP, USER_CACHE, SYSTEM_CACHE,
        USER_DATA, USER_CONFIG, SYSTEM_CFG, SYSTEM_ETC, SYSTEM_VAR, SYSTEM_PREFIX,
        SYSTEM_SHARE, PROGRAM_PLUGINS, PROGRAM_TEMP} path_t;
